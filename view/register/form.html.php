<div class="w60 m-auto form-container">
    ...
    <form action="" method="POST" >
        <div class="line-input bg-dark text-light">
            ...
            <input type="text" id="id" name="id" value="<?=$user->getId()?>" class="form-control w30 hide" <?=$disabled?>>
        </div>
        ...
        <div class="line-input bg-dark text-light">
            ...
            <input type="password" id="password" placeholder="Saisir votre mot de passe" name="password" value="" class="form-control w70" <?=$disabled?>>
        </div>
        <div class="line-input bg-dark text-light">
            <label for="confirm" class="lab30 obligatoire">CONFIRMATION</label>
            <input type="password" required id="confirm" placeholder="Confirmez votre mot de passe" name="confirm" value="" class="form-control w70" <?=$disabled?>>
        </div>
       <!--  <div class="line-input my-2">
        ...
        <div class="line-input bg-dark text-light hide">
            <label for="roles" class="lab30">ROLES</label>
