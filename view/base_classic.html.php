      ...
      <div class="row">
        ...
        <aside class="col-md-2 d-print-none">
          <div class="card">
            ...
            <img src="Public\img\produit1.jpg" alt="">
        ...
        <aside class="col-md-2">
          ...
          <div class="card text-light">
            <img src="Public\img\produit2.jpg" class="card-img">
            <div class="card-img-overlay">

              <h5 class="cart-title text-center"><span class="badge bg-dark">On vous attend...</span></h5>
